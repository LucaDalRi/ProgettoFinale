            ...
            @forelse ($dishes as $dish)
                <tr class="align-middle">
                    ...
                    <td class="text-center d-md-none">
                        <div class="d-flex justify-content-center gap-1">
                            <a href="{{route('dish.show', $dish->id)}}" class="btn btn-sm btn-primary"><i class="fa-solid fa-up-right-from-square"></i></a>
                            <a href="{{route('dish.edit', $dish->id)}}" class="btn btn-sm btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                            <form action="{{route('dishes.destroy', $dish->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
