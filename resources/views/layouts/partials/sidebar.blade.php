        ...
        <div id="list-group" class="list-group list-group-flush mx-3 mt-4">
            ...
            <div class="d-flex align-items-center">
                <a href="{{ route('dashboard') }}"
                    class="list-group-item list-group-item-action py-2 my-ripple {{ Route::current()->getName() == 'dashboard' ? 'active' : '' }}"
                    {{-- aria-current="true" --}}>
            ...
            <div class="d-flex align-items-center" id="test">
                <a href="{{ route('dishes.index') }}"
                    class="list-group-item list-group-item-action py-2 my-ripple {{ Route::current()->getName() == 'dishes.index' ? 'active' : '' }}">
